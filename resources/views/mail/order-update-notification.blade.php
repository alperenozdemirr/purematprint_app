            ...
            <td style="padding:28px 24px;">
              ...
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="margin:0 0 20px;background:#fbf8f1;border:2px solid #1a1a1a;">
                <tr>
                  <td style="padding:18px 16px;">
                    <p style="margin:0 0 8px;font-size:12px;font-weight:700;letter-spacing:0.08em;text-transform:uppercase;color:#354e9c;">Güncelleme</p>
                    <p style="margin:0;font-size:14px;line-height:1.6;color:#5e5a54;">{{ $headline }}</p>
                    @if (filled($note))
                      <p style="margin:12px 0 0;font-size:14px;line-height:1.6;color:#1a1a1a;">
                        <strong>Not:</strong> {{ $note }}
                      </p>
                    @endif
                    @if ($order->design_status)
                      <p style="margin:12px 0 0;font-size:13px;line-height:1.6;color:#5e5a54;">
              ...
              <p style="margin:0 0 20px;">
                <a href="{{ route('orderShow', $order->code) }}"
                   style="display:inline-block;padding:12px 18px;background:#354e9c;color:#faf6ee;text-decoration:none;font-size:13px;font-weight:700;letter-spacing:0.06em;text-transform:uppercase;border:2px solid #1a1a1a;">
