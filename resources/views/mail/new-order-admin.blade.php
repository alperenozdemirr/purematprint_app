        ...
        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:560px;background:#fffdf8;border:3px solid #1a1a1a;">
          <tr>
            <td style="padding:28px 24px;border-bottom:3px solid #1a1a1a;background:#354e9c;color:#faf6ee;">
              ...
              <h1 style="margin:10px 0 0;font-size:26px;line-height:1.2;">Yeni Sipariş Aldınız</h1>
            </td>
          </tr>
          <tr>
            <td style="padding:28px 24px;">
              <p style="margin:0 0 16px;font-size:15px;line-height:1.7;color:#5e5a54;">
                <strong>{{ $order->code }}</strong> numaralı yeni bir sipariş oluşturuldu ve ödeme alındı.
              </p>
              ...
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="margin:0 0 20px;background:#fbf8f1;border:2px solid #1a1a1a;">
                <tr>
                  <td style="padding:18px 16px;">
                    <p style="margin:0 0 8px;font-size:12px;font-weight:700;letter-spacing:0.08em;text-transform:uppercase;color:#354e9c;">Müşteri</p>
              ...
              @if ($order->note)
              <p style="margin:0 0 8px;font-size:12px;font-weight:700;letter-spacing:0.08em;text-transform:uppercase;color:#354e9c;">Müşteri Notu</p>
              <p style="margin:0 0 20px;font-size:14px;line-height:1.7;color:#5e5a54;">{{ $order->note }}</p>
              @endif

              <table role="presentation" cellspacing="0" cellpadding="0">
                <tr>
                  <td>
                    <a href="{{ route('admin.orderDetailPage', $order->code) }}" style="display:inline-block;padding:14px 22px;background:#5a544e;color:#faf6ee;font-size:13px;font-weight:700;text-decoration:none;text-transform:uppercase;letter-spacing:0.06em;border:2px solid #1a1a1a;">Admin Panelde Görüntüle</a>
                  </td>
                </tr>
              </table>
            </td>
          ...
          <tr>
            <td style="padding:18px 24px;border-top:3px solid #1a1a1a;background:#2a2826;color:#faf6ee;">
              <p style="margin:0;font-size:12px;line-height:1.6;opacity:0.85;">© {{ date('Y') }} PureMatPrint — Yeni sipariş bildirimi</p>
            </td>
          </tr>
        </table>
      </td>
