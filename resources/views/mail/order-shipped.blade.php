        ...
        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:560px;background:#fffdf8;border:3px solid #1a1a1a;">
          <tr>
            <td style="padding:28px 24px;border-bottom:3px solid #1a1a1a;background:#354e9c;color:#faf6ee;">
              ...
              <h1 style="margin:10px 0 0;font-size:26px;line-height:1.2;">Siparişiniz Kargoya Verildi</h1>
            </td>
          </tr>
          <tr>
              ...
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="margin:0 0 20px;background:#fbf8f1;border:2px solid #1a1a1a;">
                <tr>
                  <td style="padding:18px 16px;">
                    <p style="margin:0 0 8px;font-size:12px;font-weight:700;letter-spacing:0.08em;text-transform:uppercase;color:#354e9c;">Kargo Bilgileri</p>
                    ...
                    @endif
                    @if ($order->shipped_at)
                      <p style="margin:0 0 6px;font-size:14px;line-height:1.6;color:#5e5a54;">Kargoya Verilme: <strong>{{ $order->shipped_at->format('d.m.Y H:i') }}</strong></p>
                    @endif
                    @if ($order->tracking_url)
                      <p style="margin:8px 0 0;font-size:14px;line-height:1.6;">
                        <a href="{{ $order->tracking_url }}" style="color:#354e9c;font-weight:700;">Kargonu Takip Et →</a>
                      </p>
                    @endif
                  </td>
                </tr>
