...
@section('page_title', 'Yeni Blog Yazısı')
@section('breadcrumb', 'İçerik / Blog / Yeni')
...
@section('content')
  <div class="mb-6 flex items-center gap-3">
    ...
    <div>
      <h2 class="font-heading text-[22px] font-bold leading-tight text-ink">Yeni Blog Yazısı</h2>
      <p class="font-body text-[13px] text-muted">Blog içeriğini CKEditor ile oluşturun</p>
    </div>
  </div>
          ...
          <div class="grid grid-cols-1 gap-5 p-5">
            ...
            <div>
              ...
              <textarea id="content" name="content" rows="12" required
                        class="w-full rounded-lg border border-ink/10 bg-cream px-3.5 py-2.5 font-body text-[14px] leading-relaxed text-ink outline-none transition-colors focus:border-accent focus:ring-2 focus:ring-accent/15">{{ old('content') }}</textarea>
