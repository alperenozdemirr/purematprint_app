...
@section('title', 'Yeni Koleksiyon')
@section('page_title', 'Yeni Koleksiyon')
@section('breadcrumb', 'Katalog / Koleksiyonlar / Yeni')
...
@section('content')
  <div class="mb-6 flex items-center gap-3">
    ...
    <div>
      <h2 class="font-heading text-[22px] font-bold leading-tight text-ink">Yeni Koleksiyon Ekle</h2>
      <p class="font-body text-[13px] text-muted">Koleksiyon bilgilerini, görselini ve ürünlerini tanımlayın</p>
    </div>
  </div>

  <form action="{{ route('admin.collectionStore') }}" method="POST" enctype="multipart/form-data">
    @csrf
          ...
          <div class="grid grid-cols-1 gap-5 p-5">
            ...
            <div>
              ...
              <textarea id="description" name="description" rows="4"
                        ...
                        placeholder="Koleksiyon açıklaması...">{{ old('description') }}</textarea>
