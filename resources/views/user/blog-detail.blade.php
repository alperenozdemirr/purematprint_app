...
<main>
    <div class="w-full max-w-site mx-auto px-5 lg:px-8" data-i5="container">
      ...
      <article id="blog-article" data-i5="blog-article">
        <header class="mb-8">
        ...
        <div class="blog-prose max-w-[68ch] font-body text-[15px] leading-[1.75] text-ink [&_h2]:font-heading [&_h2]:text-xl [&_h2]:font-semibold [&_h2]:mt-9 [&_h2]:mb-3 [&_h2]:normal-case [&_p]:mb-4 [&_p]:text-muted [&_ul]:my-4 [&_ul]:pl-5 [&_ul]:list-disc [&_ul]:text-muted [&_ol]:my-4 [&_ol]:pl-5 [&_ol]:list-decimal [&_ol]:text-muted [&_li]:mb-2 [&_strong]:text-ink [&_img]:max-w-full [&_img]:h-auto [&_a]:text-accent [&_a]:underline">
          {!! $blog->content !!}
        </div>
      </article>

      @if ($relatedBlogs->isNotEmpty())
        <section class="mt-16 pt-12 border-t-[3px] border-ink" data-i5="blog-related-section">
          <h2 class="font-heading text-section-title font-semibold leading-[1.15] tracking-[-0.02em] normal-case mb-8">Diğer Yazılar</h2>
