...
@endphp
 <!-- Hero -->
  <section
    data-hero-intro
    data-i5="hero--intro"
    data-i5-tags="hero hero--intro"
    class="relative overflow-hidden border-b-[3px] border-ink bg-dark [&.hero-intro--cover_[data-hero-intro-frame]]:min-h-[clamp(440px,72vh,760px)] [&.hero-intro--cover_[data-hero-intro-frame]]:overflow-hidden [&.hero-intro--cover_[data-hero-intro-img]]:absolute [&.hero-intro--cover_[data-hero-intro-img]]:inset-0 [&.hero-intro--cover_[data-hero-intro-img]]:h-full [&.hero-intro--cover_[data-hero-intro-img]]:w-full [&.hero-intro--cover_[data-hero-intro-img]]:max-h-none [&.hero-intro--cover_[data-hero-intro-img]]:object-cover [&.hero-intro--cover_[data-hero-intro-img]]:object-center"
  >
    <div class="relative" data-hero-intro-frame data-i5="hero__media">
      <img
