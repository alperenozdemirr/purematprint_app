...
class SettingUpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'favicon' => ImageUploadRules::adminImageRules(required: false),
            'intro_title' => ['nullable', 'string', 'max:255'],
            'intro_description' => ['nullable', 'string', 'max:1000'],
            'intro_image' => ImageUploadRules::introImageRules(required: false),
            'intro_image_mobile' => ImageUploadRules::introImageRules(required: false),
    ...
    public function messages(): array
    {
        return [
            ...
            'favicon.max' => 'Site ikonu en fazla 40MB olabilir.',
            'favicon.mimes' => 'Site ikonu yalnızca '.ImageUploadRules::humanList().' formatlarında olabilir.',
            'intro_image.max' => 'Masaüstü giriş görseli en fazla 100MB olabilir.',
            'intro_image.mimes' => 'Masaüstü giriş görseli yalnızca '.ImageUploadRules::humanList().' formatlarında olabilir.',
            'intro_image_mobile.max' => 'Mobil giriş görseli en fazla 100MB olabilir.',
            'intro_image_mobile.mimes' => 'Mobil giriş görseli yalnızca '.ImageUploadRules::humanList().' formatlarında olabilir.',
