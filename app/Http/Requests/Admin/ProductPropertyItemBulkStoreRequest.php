...
class ProductPropertyItemBulkStoreRequest extends FormRequest
{
    ...
    protected function prepareForValidation(): void
    {
        ...
        // Paste alanı: her satır "Başlık|Fiyat" veya sadece "Başlık"
    ...
    {
        return [
            'items.required' => 'En az bir seçenek ekleyin.',
            'items.min' => 'En az bir seçenek ekleyin.',
            'items.max' => 'Tek seferde en fazla 100 seçenek ekleyebilirsiniz.',
        ];
    }
}
